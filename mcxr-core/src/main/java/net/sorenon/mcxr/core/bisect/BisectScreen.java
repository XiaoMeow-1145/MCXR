...
public class BisectScreen extends Screen {
        ...
        editBox = this.addRenderableWidget(new EditBox(this.minecraft.font, this.width / 2 - 100, this.height / 4 + 48, 200, 20, new TextComponent("Enter email...")) {
            ...
            public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
                if (keyCode == GLFW.GLFW_KEY_ENTER) {
                    ...
                    BisectScreen.this.minecraft.getToasts().addToast(new SystemToast(SystemToast.SystemToastIds.PERIODIC_NOTIFICATION, new TextComponent("Check your email!"), new TextComponent("")));
                    BisectScreen.this.onClose();
                }
                return super.keyPressed(keyCode, scanCode, modifiers);
            }
        });
        this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, new TranslatableComponent("addServer.add"), (button) -> {
            sendEmail(editBox.getValue());
            BisectScreen.this.minecraft.getToasts().addToast(new SystemToast(SystemToast.SystemToastIds.PERIODIC_NOTIFICATION, new TextComponent("Check your email!"), null));
            this.onClose();
        }));
    }
    ...
    public void render(@NotNull PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawString(matrices, this.font, new TextComponent(text), this.width / 2 - 100, this.height / 4 + 36, textColor);
