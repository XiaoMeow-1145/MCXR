...
public class AddServerScreen extends Screen {
    ...
    protected void init() {
        ...
        EditBox editbox = new EditBox(minecraft.font, (this.width) / 2 - 100, (this.height / 2) - 10, 200, 20, new TextComponent("EditBox"));
        XrEditBoxScreen kb = new XrEditBoxScreen(new TextComponent("KB"), multiplayerScreen, editbox, multiplayerScreen.getServers());
